...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!quit) {
            ...
            boolean hasInteger = keyboard.hasNextInt(); // Check if input is an integer
            if (hasInteger) {
            ...
            switch (menuChoice) { // Based on the menu choice
                case 0:
                    quit = true;
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Cylinder cylinder = calculateCylinder();  // Calculate and get cylinder details
    ...
    public static double calculateCircle(){
     ...
     // Method to validate user input for numbers
